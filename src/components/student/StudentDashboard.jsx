  ...
  return (
    <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-8 space-y-6 sm:space-y-8">
      ...
      <div className="relative overflow-hidden rounded-3xl glass-panel p-4 sm:p-8 border border-slate-200/90 shadow-xl">
        ...
        {/* Tab Navigation Segment (Fully Responsive Scroll) */}
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {filteredFeed.map((req) => (
              <div key={req.id} className="glass-card p-4 sm:p-6 rounded-3xl flex flex-col justify-between space-y-4 sm:space-y-5 relative overflow-hidden border border-slate-200/90 group">
                <div className="space-y-4">
                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex items-center gap-3">
                      ...
                      />
                      <div>
                        <h3 className="font-black text-sm sm:text-base text-slate-900 group-hover:text-blue-900 transition-colors leading-tight">{req.title}</h3>
                        <div className="text-xs text-slate-700 font-black mt-0.5">{req.company_name} • {req.job_type}</div>
                      </div>
                    </div>

                    <div className={`px-2.5 sm:px-3 py-1.5 rounded-2xl border text-center font-black text-xs shrink-0 shadow-sm ${
                      !req.eligible
                  ...
                  <div className="grid grid-cols-2 gap-2 text-[11px] text-slate-700 bg-slate-100/90 p-3 rounded-2xl border border-slate-200 font-bold">
                ...
                {/* Footer Action Buttons (Fully Responsive Stack/Row) */}
                <div className="pt-3 border-t border-slate-200/90 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2.5">
                  <button
      ...
      {activeTab === 'profile' && (
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="glass-card p-5 sm:p-6 rounded-3xl border border-slate-200/90 space-y-4">
              ...
              <div className="space-y-3 text-xs font-bold">
                ...
                <div>
                  <div className="flex justify-between text-slate-900 mb-1">
                    <span>React & Full-Stack Web</span>
                    <span className="text-blue-900 font-black">90% Fit</span>
                  </div>
                  <div className="w-full bg-slate-100 h-3 rounded-full overflow-hidden border border-slate-200">
                    <div className="bg-gradient-to-r from-indigo-800 to-blue-600 h-full rounded-full" style={{ width: '90%' }}></div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="glass-card p-5 sm:p-6 rounded-3xl border border-slate-200/90 space-y-4">
              ...
              <div className="flex items-center justify-around gap-4 pt-2">
                <div className="relative w-28 h-28 sm:w-32 sm:h-32 flex items-center justify-center shrink-0">
                  <svg className="w-full h-full transform -rotate-90">
                    <circle cx="64" cy="64" r="50" stroke="currentColor" strokeWidth="12" className="text-slate-100" fill="transparent" />
                    <circle cx="64" cy="64" r="50" stroke="#1e3a8a" strokeWidth="12" strokeDasharray="314" strokeDashoffset="125" fill="transparent" />
                  </svg>
                  <div className="absolute text-center">
                    <span className="text-base font-black text-slate-900">100%</span>
                    <span className="text-[9px] text-slate-600 block font-black">TOTAL FIT</span>
                  </div>
                </div>
        ...
        <div className="glass-panel p-4 sm:p-6 rounded-3xl border border-slate-200/90 space-y-4">
          ...
          <div className="space-y-4">
            {applications.map((app) => (
              <div key={app.id} className="glass-card p-4 sm:p-5 rounded-2xl border border-slate-200/90 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                <div className="flex items-center gap-3.5">
                  <img
                    src={app.logo_url || 'https://images.unsplash.com/photo-1542744094-3a31b272c490?w=100&auto=format&fit=crop&q=60'}
                    alt={app.company_name}
                    className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl object-contain bg-slate-50 p-1.5 border border-slate-200 shrink-0"
                  />
                  <div>
